...
export const complaints: Complaint[] = [
  { id: 1, title: 'Severe Potholes near Andheri Flyover', description: 'Multiple deep potholes on the southbound main road. Damaging tires and causing sudden braking.', category: 'pothole', geometry: { type: 'Point', coordinates: [72.8531, 19.1190] }, status: 'in_progress', escalationLevel: 0, assignedAuthorityId: 5, roadId: 1, createdAt: '2026-05-15T10:30:00Z' },
  { id: 2, title: 'Missing diversion board near Metro work', description: 'The lane closure indicator is missing. Extremely hazardous at night.', category: 'missing_signage', geometry: { type: 'Point', coordinates: [72.8580, 19.1720] }, status: 'resolved', escalationLevel: 0, assignedAuthorityId: 5, roadId: 1, createdAt: '2026-05-10T14:15:00Z' },
  { id: 3, title: 'Uneven Paver Blocks at Bandra Signal', description: 'The interlocking bricks have caved in. Creates a massive bump for motorbikes.', category: 'paving_defect', geometry: { type: 'Point', coordinates: [72.8356, 19.0620] }, status: 'pending', escalationLevel: 0, assignedAuthorityId: 1, roadId: 3, createdAt: '2026-05-22T08:00:00Z' },
  { id: 4, title: 'Monsoon Waterlogging outside station', description: 'Water level reaches knee height during high tide rains. Drain inlets are fully clogged.', category: 'waterlogging', geometry: { type: 'Point', coordinates: [72.8362, 19.0980] }, status: 'in_progress', escalationLevel: 1, assignedAuthorityId: 1, roadId: 3, createdAt: '2026-05-20T17:45:00Z' },
  { id: 5, title: 'Dumping of building debris on left lane', description: 'Truckloads of sand and broken concrete bricks left on the road blocking traffic.', category: 'debris', geometry: { type: 'Point', coordinates: [72.8272, 19.1260] }, status: 'routed', escalationLevel: 0, assignedAuthorityId: 1, roadId: 4, createdAt: '2026-05-18T11:20:00Z' },
  { id: 6, title: 'Crater-sized pothole near Kurla junction', description: 'Nearly 1.5 feet deep. Several auto-rickshaws have overturned trying to avoid it.', category: 'pothole', geometry: { type: 'Point', coordinates: [72.8982, 19.0850] }, status: 'in_progress', escalationLevel: 0, assignedAuthorityId: 3, roadId: 5, createdAt: '2026-05-19T09:15:00Z' },
  { id: 7, title: 'Stagnant water near Phoenix mall entrance', description: 'Clogged drains from construction are backing up water onto the road.', category: 'waterlogging', geometry: { type: 'Point', coordinates: [72.9030, 19.1020] }, status: 'pending', escalationLevel: 2, assignedAuthorityId: 3, roadId: 5, createdAt: '2026-05-21T13:40:00Z' },
  { id: 8, title: 'Potholes on Vikhroli stretch', description: 'Fast-moving traffic is lane-splitting dangerously to avoid three deep potholes.', category: 'pothole', geometry: { type: 'Point', coordinates: [72.9345, 19.1080] }, status: 'resolved', escalationLevel: 0, assignedAuthorityId: 4, roadId: 2, createdAt: '2026-05-12T16:00:00Z' },
  { id: 9, title: 'Scraped asphalt piles on side shoulder', description: 'Scraped road surface from roadwork left on the road shoulder. Blowing dust everywhere.', category: 'debris', geometry: { type: 'Point', coordinates: [72.9465, 19.1710] }, status: 'routed', escalationLevel: 0, assignedAuthorityId: 4, roadId: 2, createdAt: '2026-05-16T15:30:00Z' },
  { id: 10, title: 'Fallen speed limit board near school zone', description: 'The pole was hit by a truck and is lying flat on the pavement.', category: 'missing_signage', geometry: { type: 'Point', coordinates: [72.8262, 18.9860] }, status: 'resolved', escalationLevel: 0, assignedAuthorityId: 2, roadId: 6, createdAt: '2026-05-14T10:00:00Z' },
  { id: 11, title: 'Sinking road surface near Dadar TT flyover base', description: 'The road surface has depressed, forming a deep depression that fills with water.', category: 'paving_defect', geometry: { type: 'Point', coordinates: [72.8502, 18.9960] }, status: 'pending', escalationLevel: 1, assignedAuthorityId: 2, roadId: 7, createdAt: '2026-05-22T12:00:00Z' },
  { id: 12, title: 'JVLR Metro Pillar 12 Potholes', description: 'Multiple defects right next to the metro construction barricade.', category: 'pothole', geometry: { type: 'Point', coordinates: [72.8820, 19.1285] }, status: 'in_progress', escalationLevel: 0, assignedAuthorityId: 4, roadId: 8, createdAt: '2026-05-17T09:00:00Z' },
  { id: 13, title: 'Expansion joint gaps on SCLR flyover', description: 'The steel bridge expansion joints are misaligned, causing heavy shocks to cars.', category: 'paving_defect', geometry: { type: 'Point', coordinates: [72.8795, 19.0695] }, status: 'pending', escalationLevel: 0, assignedAuthorityId: 4, roadId: 9, createdAt: '2026-05-22T14:00:00Z' },
  { id: 14, title: 'Spilled gravel near Ovala junction', description: 'Dumper truck spilled small gravel stones on the fast lane, making it slippery for two-wheelers.', category: 'debris', geometry: { type: 'Point', coordinates: [72.9315, 19.2525] }, status: 'resolved', escalationLevel: 0, assignedAuthorityId: 4, roadId: 10, createdAt: '2026-05-11T16:00:00Z' },
  { id: 15, title: 'Loose concrete flags near promenade', description: 'Footpath stones are loose. Pedestrians trip when stepping on them.', category: 'paving_defect', geometry: { type: 'Point', coordinates: [72.8211, 18.9325] }, status: 'resolved', escalationLevel: 0, assignedAuthorityId: 2, roadId: 11, createdAt: '2026-05-13T10:00:00Z' },
  { id: 16, title: 'Highway potholes near Mankhurd T-junction', description: 'Large asphalt crater that slows down the highway bottleneck entry.', category: 'pothole', geometry: { type: 'Point', coordinates: [72.9250, 19.0415] }, status: 'in_progress', escalationLevel: 0, assignedAuthorityId: 5, roadId: 12, createdAt: '2026-05-18T10:00:00Z' },
  { id: 17, title: 'Pothole on Malad flyover descent', description: 'Located in the middle lane, extremely dangerous due to highway speeds.', category: 'pothole', geometry: { type: 'Point', coordinates: [72.8592, 19.1865] }, status: 'rejected', escalationLevel: 0, assignedAuthorityId: 5, roadId: 1, createdAt: '2026-05-20T11:00:00Z' },
  { id: 18, title: 'Water pooling under Oshiwara bridge', description: 'Even short showers result in water accumulating in the lower dip of the road.', category: 'waterlogging', geometry: { type: 'Point', coordinates: [72.8312, 19.1835] }, status: 'pending', escalationLevel: 0, assignedAuthorityId: 1, roadId: 4, createdAt: '2026-05-22T09:00:00Z' },
  { id: 19, title: 'Discarded steel pipes near Bhandup station', description: 'Leftover water pipeline project pipes blocking the footpaths and active street lane.', category: 'debris', geometry: { type: 'Point', coordinates: [72.9348, 19.1975] }, status: 'routed', escalationLevel: 0, assignedAuthorityId: 3, roadId: 5, createdAt: '2026-05-19T10:00:00Z' },
  { id: 20, title: 'Broken lane divider reflectors near Vashi Bridge', description: 'Cat-eye reflectors have broken off. Hard to see lane markings in heavy rain.', category: 'missing_signage', geometry: { type: 'Point', coordinates: [72.9982, 19.0402] }, status: 'pending', escalationLevel: 0, assignedAuthorityId: 5, roadId: 12, createdAt: '2026-05-22T10:00:00Z' }
];
